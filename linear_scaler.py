...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        group1scale = gr.TextBox(label="Group 1 scales", value="")
        group1_isneg = gr.Checkbox(label="Is negative prompt", value=False)
        group2kw = gr.TextBox(label="Group 2 prompts", value="")
        group2scale = gr.TextBox(label="Group 2 scales", value="")
        group2_isneg = gr.Checkbox(label="Is negative prompt", value=False)
        group3kw = gr.TextBox(label="Group 3 prompts", value="")
        group3scale = gr.TextBox(label="Group 3 scales", value="")
        group3_isneg = gr.Checkbox(label="Is negative prompt", value=False)
        group4kw = gr.TextBox(label="Group 4 prompts", value="")
        group4scale = gr.TextBox(label="Group 4 scales", value="")
        group4_isneg = gr.Checkbox(label="Is negative prompt", value=False)
        return [group1kw, group1scale, group1_isneg,
                group2kw, group2scale, group2_isneg,
                group3kw, group3scale, group3_isneg,
                group4kw, group4scale, group4_isneg
                ]
    ...
    def run(self, p, x_type, x_values, y_type, y_values, draw_legend, include_lone_images, no_fixed_seeds):
        ...
        with SharedSettingsStackHelper():
            processed = draw_xy_grid(
                ...
                xs=xs,
                ys=ys,
                x_labels=[], # TODO think of something to put for the labels
                y_labels=[], # TODO think of something to put for the labels
                cell=cell,
                draw_legend=False, 
